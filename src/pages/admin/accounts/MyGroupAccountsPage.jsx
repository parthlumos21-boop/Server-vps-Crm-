...
const getAccountCreatedTime = (row = {}) => {
  const candidates = [
    row.createdAt,
    row.raw?.createdAt,
    row.accountDate,
...
const compareAccountRowsNewestFirst = (left = {}, right = {}) => {
  const timeDifference = getAccountCreatedTime(right) - getAccountCreatedTime(left)
...
const activeStageParam = searchParams.get('stage')
  ...
  const filteredRows = useMemo(
    () => boardRows
      ...
      .sort(compareAccountRowsNewestFirst),
